      ...
      <div className="relative z-10 isolate px-2 lg:px-8 h-full">
        <div className="mx-auto max-w-2xl pt-26 sm:py-48 lg:py-52 h-full">
          <div className="flex flex-col h-full">
            <h2 className="text-6xl canva-bold font-extrabold text-white sm:text-6xl w-1/3 leading-16">
              Travel Without Limits
            </h2>

            <p className="mt-8 text-base font-bold canva-regular text-zinc-300">
              The wiki pidea for Hikers, where discover hidden places
            </p>

            <div className='mt-auto canva-regular'>
              {!user && (
                <div className="mb-4 flex items-center justify-center gap-x-6  font-bold  bg-blue-400 py-4 rounded-full text-white">
                  <Link to="/auth">
                    <button type=""
                      className="
              ...
              <div className=' mb-20 text-sm tracking-wide  bg-white text-center font-semibold text-black py-4 rounded-full w-full'>
                <a href="/search">
                  Explore the world
                </a>
              </div>
      ...
      <section className="overflow-hidden pb-16 h-screen">
        ...
        <div className="mx-auto max-w-7xl px-10 max-sm:py-10 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            ...
            {/* LEFT SIDE */}
            <div className="space-y-2 canva-bold ">
              <h2 className="text-2xl tracking-wide text-white sm:text-5xl">
