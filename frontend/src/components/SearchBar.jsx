...
export default function SearchBar() {
  ...
  return (
    <div className='flex justify-center'>
      <div className='flex items-center border-1 border-gray-400 text-gray-300 pl-4 h-8'>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <button type="submit"
          className="border-1 border-gray-400 bg-gray-700 text-white p-2 hover:cursor-pointer h-8 hover:bg-gray-600 items-center flex"
        > Search</button>
      </form>
    </div >
  )
